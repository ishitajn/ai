...
POSITIVE_WORDS = {
    ...
    "interesting": 0.5, "nice": 0.5, "cool": 0.4
}
NEGATIVE_WORDS = {
...
VULNERABLE_WORDS = [
    ...
    "i struggle with", "i'm worried", "nervous", "opening up", "it's been tough",
...
GEO_TRIGGERS = {
    ...
    "country", "city", "town", "location", "neighborhood", "here", "there"
}
PROFESSIONAL_WORDS = {
...
COMPLIMENT_WORDS = {
    ...
    "perfect", "sexy", "stunning", "sweet", "wonderful"
}
...
GREETING_KEYWORDS = {
    ...
    "morning", "'morning", "good afternoon", "afternoon", "good evening", "evening"
}
...
SHIT_TEST_PATTERNS = [
    ...
    r"are you trying to",
    r"you must be",
    r"\bslow down\b",  # e.g., "Let's slow down a bit"
    r"getting to know you",
    r"\bfar away\b",  # Logistical test
    r"in the next few weeks",  # Delaying tactic
]
